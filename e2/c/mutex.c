...
int main(int argc, char *argv[])
{
    ...
    {
        /* 
        Here we use the address-of the thread to get its id from the threads array,
        the signature is 
        (thread pointer to store ID,
        PTHREAD attribute (u can do fancy stuff here),
        pointer to a function thats why inc is *inc,
        last argument I've never used :D)
        */ 
